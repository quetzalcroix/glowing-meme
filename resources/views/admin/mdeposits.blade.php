									...
									<tbody>
										...
										<tr>
											...
											<a href="#" class="btn btn-{{$text}} btn-sm m-1" data-toggle="modal" data-target="#popModal{{$deposit->id}}" title="View payment proof">
												...
												<a href="{{ url('rangda/v2/dashboard/deldeposit') }}/{{$deposit->id}}" class="m-1 btn btn-danger btn-sm">Delete</a>
												@if($deposit->status =="Processed")
												<a class="btn btn-success btn-sm" href="#">Processed</a>
												@else
												<a class="btn btn-primary btn-sm" href="{{ url('rangda/v2/dashboard/pdeposit') }}/{{$deposit->id}}">Process</a>
												@endif
