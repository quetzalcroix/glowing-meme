...
<div class="main-header">
  ...
  <div class="logo-header" data-background-color="{{$bgmenu}}">
    <a href="{{route('home')}}" class="logo">
      <img src="{{asset('images/logo_tro.png')}}" height="48" alt="Digest TRO">
    </a>
    <button class="ml-auto navbar-toggler sidenav-toggler" type="button" data-toggle="collapse" data-target="collapse" aria-expanded="false"
          ...
          <li class="nav-item dropdown hidden-caret">
            ...
            <div class="dropdown-menu quick-actions quick-actions-info animated fadeIn">
              <div class="quick-actions-header">
                ...
                @if(empty(auth()->user()->account_verify) || is_null(auth()->user()->account_verify))
                  <span class="subtitle op-8">
                      <a>KYC status: {{Auth::user()->account_verify ?? 'Unverified' }}</a>
                  </span>
                @else
                  <span class="subtitle op-8">
                    <a href="#" class="p-0 col-12">
                        <i class="glyphicon glyphicon-ok">
                        </i> KYC status: Account verified
                    </a>
                </span>
                @endif
              </div>
