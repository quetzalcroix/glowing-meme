                                            ...
                                            <div class="p-1 col-md-4">
                                                <div class="card border p-1 bg-{{Auth('admin')->User()->dashboard_style}}">
                                                    <div class="card-body">
                                                        ...
                                                        <a href="{{ url('rangda/v2/dashboard/delfaq') }}/{{$faq->id}}" type="button" data-toggle="tooltip" title="" class="btn btn-sm btn-danger" data-original-title="Remove"><i class="fa fa-times"></i></a> &nbsp;
                                        ...
                                        @foreach($testimonies as $faq)
                                            <div class="p-1 col-md-4">
                                                <div class="card border p-1 bg-{{Auth('admin')->User()->dashboard_style}}">
                                                    ...
                                                    <div class="card-body">
                                                        <a href="{{ url('rangda/v2/dashboard/deltestimony') }}/{{$faq->id}}" type="button" data-toggle="tooltip" title="" class="btn btn-sm btn-danger" data-original-title="Remove"><i class="fa fa-times"></i></a> &nbsp; &nbsp;
