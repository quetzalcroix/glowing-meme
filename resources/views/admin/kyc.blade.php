								...
								<table id="ShipTable" class="table table-hover  text-{{$text}}">
									...
									<tbody>
										...
										<tr>
											...
											<a href="{{ url('rangda/v2/dashboard/acceptkyc') }}/{{$list->id}}" class="btn btn-primary btn-sm">Accept</a>
											 <a href="{{ url('rangda/v2/dashboard/rejectkyc') }}/{{$list->id}}" class="btn btn-danger btn-sm">Reject</a>
											 </td>
										</tr>
