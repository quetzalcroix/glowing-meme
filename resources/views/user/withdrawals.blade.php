          ...
          @foreach($wmethods as $method)
            <div class="col-lg-4 p-3 rounded card bg-{{$bg}}">
              <div class="shadow card-body border-danger">
                ...
                <h4 class="text-{{$text}}">Charges (Fixed):<strong style="float:right;"> {{$settings->currency}}{{$method->charges_fixed}}</strong>
                </h4><br>
                ...
                <div class="text-center">
                  @if ($settings->enable_with == "true")
                    <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#withdrawdisabled"><i class="fa fa-plus"></i> Request
                      withdrawal</a>
                  @else
                    <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#withdrawalModal{{$method->id}}"><i class="fa fa-plus"></i>
