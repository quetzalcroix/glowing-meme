...
class CrmController extends Controller
{
    ...
    public function addtask(Request $request)
    {
        ...
        return redirect()->back()->with('message', 'Task Sucessfully Created and Assigned!');
    }

    public function updatetask(Request $request)
    {
        Task::where('id', $request['id'])->update([
            'title'      => $request['tasktitle'], 'note' => $request['note'], 'designation' => $request['delegation'],
            'start_date' => $request['start_date'], 'end_date' => $request['end_date'], 'priority' => $request['priority'],
            // 'status' => "Pending",
          ]);
    ...
    public function markdone($id)
    {
        ...
        return redirect()->back()->with('message', 'Task has been Completed!');
    }
    ...
    public function convert($id)
    {
        ...
        return redirect()->back()->with('message', 'User Converted successfully');
    }

    public function assign(Request $request)
    {
        users::where('id', $request['user_name'])->update([
        ...
        //Mail::bcc($mailduser->email)->send(new NewNotification($objDemo));
        return redirect()->back()->with('message', 'Successfully Assigned User to Admin');
    }
}
