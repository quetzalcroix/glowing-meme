                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu bg-{{Auth('admin')->User()->dashboard_style}}" aria-labelledby="dropdownMenuLink">
                          ...
                          @if($admin->acnt_type_active==null || $admin->acnt_type_active=='blocked')
                            <a class="m-1 btn btn-primary btn-sm" href="{{ url('rangda/v2/dashboard/unblock') }}/{{$admin->id}}">Unblock</a>
                          @else
                            <a class="m-1 btn btn-danger btn-sm" href="{{ url('rangda/v2/dashboard/ublock') }}/{{$admin->id}}">Block</a>
                          @endif
                          <a href="#" data-toggle="modal" data-target="#resetpswdModal{{$admin->id}}" class="m-1 btn btn-warning btn-sm">Reset
                            Password</a>
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body bg-{{Auth('admin')->User()->dashboard_style}} p-3">
                          <p class="text-{{$text}}">Are you sure you want to reset password for {{$admin->firstName}} to <span
                              class="text-primary font-weight-bolder">admin01236</span></p>
                          <a class="btn btn-danger" href="{{ url('rangda/v2/dashboard/resetadpwd') }}/{{$admin->id}}">Reset Now</a>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body bg-{{Auth('admin')->User()->dashboard_style}} p-3">
                          ...
                          <a class="btn btn-danger" href="{{ url('rangda/v2/dashboard/deluser') }}/{{$admin->id}}">Yes i'm sure</a>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="modal-body bg-{{Auth('admin')->User()->dashboard_style}}">
                          <form style="padding:3px;" role="form" method="post" action="{{route('editadmin')}}">
                            ...
                            <input style="padding:5px;" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}"
                                   value="{{$admin->firstName}}" type="text" name="fname" required><br/>
                            <h5 class=" text-{{$text}}">Lastname</h5>
                            <input style="padding:5px;" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}"
                                   value="{{$admin->lastName}}" type="text" name="l_name" required><br/>
                            <h5 class=" text-{{$text}}">Email</h5>
                            <input style="padding:5px;" class="form-control bg-{{Auth('admin')->User()->dashboard_style}} text-{{$text}}"
                                   value="{{$admin->email}}" type="email" name="email" required><br/>
