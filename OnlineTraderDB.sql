...
(1, 'OnlineTrader', 'We are online', '$', 'USD', 'International BNK', 'Admin account c', '99388383', 'sdjkbhfff', 'ksjhhjhdjd', 'jjhhdhdhd', '123567', 'Local', 'sk_test_4eC39HqLyjWDarjtT1zdp7dc', 'pk_test_TYooMQauvdEDq54NiTphI7jx', 'jijdjkdkdk', 'iidjdjdj', 'online trade, forex, cfd,', 'Welcome to Online Trade', 'https://onlinefx.brynamics.xyz/', 'upload-logo.png1617292120', 'upload-favicon.png1617293031', 'on', 'on', 'true', 'support@onlintrader.com', '40', '30', '20', '10', '5', '1', '0', 'OT_viXHf', 'tawk to code', 'no', 'yes', 'false', 'false', 'manual', 'dark', 'Web dashboard only', 'on', NULL, NULL, '30', '40', '80', 'Welcome to Online trader version 3 with a lot of Security Features', NULL, NULL, '2021-04-02 20:12:15');
