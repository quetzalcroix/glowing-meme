                                    ...
                                    <tr>
                                        <td>{{$sub->tuser->name}} {{$sub->tuser->l_name}}</td>
                                            ...
                                            <td>
												...
												<a href="{{ url('rangda/v2/dashboard/confirmsub') }}/{{$sub->id}}" class="btn btn-primary btn-sm mb-2">Process</a>
												@else
												<a class="btn btn-success btn-sm mb-2">Active</a>
                                                @endif
                                                <a href="{{ url('rangda/v2/dashboard/delsub') }}/{{$sub->id}}" class="btn btn-danger btn-sm">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
