...
class UsersController extends Controller
{
    public function index()
    {
        ...
        return view('home.index')->with([
          'settings'          => $settings, 'total_users' => User::count(), 'plans' => Plans::all(), 'total_deposits' => $total_deposits,
          'total_withdrawals' => $total_withdrawals, // 'logosrc' => $src,
          // 'favsrc' => $favsrc,
          'faqs'              => Faq::orderby('id', 'desc')->get(), 'test' => Testimony::orderby('id', 'desc')->get(),
          'withdrawals'       => Withdrawal::orderby('id', 'DESC')->take(7)->get(), 'deposits' => Deposit::orderby('id', 'DESC')->take(7)->get(),
          'title'             => $settings->site_title, 'mplans' => Plans::where('type', 'Main')->get(),
    ...
    public function licensing()
    {
        return view('home.licensing')->with([
          'mplans' => Plans::where('type', 'Main')->get(), 'pplans' => Plans::where('type', 'Promo')->get(),
          'title'  => 'Licensing, regulation and registration', 'settings' => Settings::where('id', '=', '1')->first(),
        ]);
    }
    ...
    public function terms()
    {
        return view('home.terms')->with([
          'mplans' => Plans::where('type', 'Main')->get(), 'title' => 'Terms of Service', 'settings' => Settings::where('id', '=', '1')->first(),
        ]);
    }
    ...
    public function privacy()
    {
        return view('home.privacy')->with([
          'mplans' => Plans::where('type', 'Main')->get(), 'title' => 'Privacy Policy', 'settings' => Settings::where('id', '=', '1')->first(),
        ]);
    }
    ...
    public function faq()
    {
        return view('home.faq')->with([
          'mplans'   => Plans::where('type', 'Main')->get(), 'pplans' => Plans::where('type', 'Promo')->get(), 'title' => 'FAQs',
          'settings' => Settings::where('id', '=', '1')->first(),
        ]);
    }
    ...
    public function about()
    {
        return view('home.about')->with([
          'mplans' => Plans::where('type', 'Main')->get(), 'title' => 'About', 'settings' => Settings::where('id', '=', '1')->first(),
        ]);
    }
    ...
    public function contact()
    {
        return view('home.contact')->with([
          'mplans'   => Plans::where('type', 'Main')->get(), 'pplans' => Plans::where('type', 'Promo')->get(), 'title' => 'Contact',
          'settings' => Settings::where('id', '=', '1')->first(),
        ]);
    }
    ...
    public function updateacct(Request $request)
    {
        ...
        return redirect()->back()->with('message', 'Payment Information Updated!');
    }

    //return add change password form
    public function changepassword(Request $request)
    {
        return view('user.changepassword')->with(['title' => 'Change Password', 'settings' => Settings::where('id', '=', '1')->first()]);
    }
    ...
    public function makeadmin(Request $request, $id, $action)
    {
        ...
        return redirect()->back()->with('message', "User type has been changed successful!.");
    }
    ...
    {
        $array = User::all();
        return view('user.referuser')->with([
          'title' => 'Refer Users', 'team' => User::where('ref_by', 0)->get(), 'settings' => Settings::where('id', '=', '1')->first()
        ]);
    }
    ...
    public function getdownlines($array, $parent = 0, $level = 0)
    {
        ...
        foreach ($array as $entry) {
          ...
          <td> $levelQuote </td>".'<td>'.$this->getUserParent($entry->id).'</td>'.'<td>'.$this->getUserStatus($entry->id).'</td>
    ...
    function forgotpassword()
    {
        return view('auth.forgot-password', [
          'title' => 'Forgot Password', 'settings' => Settings::where('id', '1')->first(),
        ]);
    }
    ...
    function verifyemail()
    {
        ...
        return view('auth.verify-email', [
          'title' => 'Verify your email address', 'settings' => Settings::where('id', '1')->first(),
        ]);
    }
    ...
    function twofa()
    {
        return view('profile.show', [
          'title' => 'Two Factor Authentication', 'settings' => Settings::where('id', '1')->first(),
        ]);
    }
    ...
    function verifyaccount()
    {
        return view('user.verify', [
          'title' => 'Verify your Account', 'settings' => Settings::where('id', '1')->first(),
        ]);
    }
    ...
    public function paywithcard(Request $request, $amount)
    {
        ...
        return view('user.payment')->with([
          'title' => 'Pay with card', 't_p' => $t_p, 'settings' => Settings::where('id', '=', '1')->first()
        ]);
    ...
    public function charge(Request $request)
    {
        ...
        User::where('id', Auth::user()->id)->update([
          'confirmed_plan' => Auth::user()->plan, 'activated_at' => Carbon::now(), 'last_growth' => Carbon::now(),
        ]);
        //get plan
        ...
        if ( ! empty(Auth::user()->ref_by)) {
            ...
            User::where('id', Auth::user()->ref_by)->update([
              'account_bal' => $agent->account_bal + $earnings,
            ]);
            //create history
            Tp_Transaction::create([
              'user' => auth::user()->id, 'plan' => "Credit", 'amount' => $earnings, 'type' => "Ref_bonus",
            ]);
