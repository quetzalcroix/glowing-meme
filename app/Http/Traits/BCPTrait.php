    ...
    public function paywithcp($amount, $coin, $up, $ui, $msg)
    {
        ...
        if ($msg == 'new') {
            ...
            $req = [
              ...
              'item_name' => 'Account deposit', 'ipn_url' => "",
            ];
              ...
              print 'Error: '.$result['error']."\n";
                ...
                if ($result['error'] == 'ok') {
                    ...
                    if ($status >= 100 || $status == 2) {
                        ...
                        //Update txn info on cp_txns
                        cp_transactions::where('id', $txn->id)->update([
                        ...
                        user_plans::where('id', $txn->user_plan)
                          ...
                          ->update([
                            'amount'      => $txn->amount_paid, 'active' => "yes", 'activated_at' => Carbon::now(),
                        ...
                        if ( ! empty($user->ref_by) || $user->ref_by != "0") {
                            ...
                            users::where('id', $duser->id)->update([
