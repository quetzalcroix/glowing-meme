        ...
        <div class="mb-5 row">
          <div class="col-12 card p-3 shadow bg-{{auth('admin')->user()->dashboard_style}} text-{{$text}}">
            <div class="bs-example widget-shadow table-responsive" data-example-id="hoverable-table">
              <a href="#" data-toggle="modal" data-target="#addagentModal" class="btn btn-{{$text}} btn-lg" style="margin:10px;"> <i
              ...
              <table id="ShipTable" class="table table-hover text-{{$text}}">
                ...
                @foreach($agents as $agent)
                  ...
                  <!--<td>{{$agent->total_activated}}</td>
                    ...
                    <td>
                      <a class="btn btn-{{$text}}" href="{{url('rangda/v2/dashboard/viewagent')}}/{{$agent->agent}}" title="View agent clients">
                        <i class="fa fa-eye"></i>
                      </a>
                      <a class="btn btn-{{$text}}" href="{{url('rangda/v2/dashboard/delagent')}}/{{$agent->id}}" style="color:red;"
                         title="Remove agent clients">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body bg-{{auth('admin')->user()->dashboard_style}}">
                        <form style="padding:3px;" role="form" method="post"
                          ...
                          <input class="form-control bg-{{auth('admin')->user()->dashboard_style}} text-{{$text}}"
                                 placeholder="Increment referred users" type="number" min="0" name="referred_users" value="0"><br/>
