    ...
    <div class="row justify-content-center user-auth">
      <div class="col-12 col-md-6 col-lg-6 col-sm-10 col-xl-6">
        <div class="mb-4 text-center">
          <a href="{{url('/')}}"><img src="{{ asset('storage/app/public/photos/'.$settings->logo)}}" alt="{{$settings->site_name}}" title=""
          ...
          <form method="POST" action="{{ route('register') }}" class="mt-5 card__form">
            ...
            <div class="form-row">
              <div class="form-group col-md-12">
                ...
                <input type="text" class="mr-2 form-control" name="name" value="{{ old('name') }}" id="f_name" placeholder="Enter Full Name">
              </div>
